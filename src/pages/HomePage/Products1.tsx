...
const Products1 = () => {
  return (
    <div className="w-full h-[100%] py-[20px] flex justify-center items-center">
        <div className="w-[90%] flex flex-col md:flex-row md:justify-between gap-4 md:gap-0">
            ...
            <div className="w-full md:w-[58%] h-[30vh] shadow-m border-gray-300 border-[1px] rounded-md flex justify-between p-2 hover:bg-gray-100  transition-all duration-300 ease-in-out bg-bg1 bg-center bg-cove">
                <div className="w-[35%]">
